...
export default class ExerciseSettingsScreen extends React.PureComponent<ExerciseSettingsProps> {
  handleAddAttempt = () => {
    ...
    return (
      <RN.View style={[s.flx_i, s.jcsb, s.bg_greyLightest]}>
        ...
        <RN.View style={[s.flx_i, s.bg_blueDark, s.jcsb, s.pb175, s.ph125]}>
              ...
              <RN.View style={[s.aic, s.flx_row]}>
                ...
                >
                  <Icon
                    name="md-add"
                    size={sizes[175]}
                    color={exercise.attempts.other.length >= 99 ? colors.blueDark : colors.white}
                  />
                </RN.TouchableOpacity>
              </RN.View>
            </RN.View>
          ...
          <RN.View>
            <RN.TouchableOpacity style={[s.asc, s.bg_green, s.br2, s.h325, s.jcc, s.ph4, s.mb075]} onPress={onDone}>
